...
export default function Roles({ direction }) {
  ...
  function deal() {
    ...
    // new change for scroll:
    const element = document.getElementById('section-acc');
    if(element){
  ...
  return (
    <div className='box'>
      ...
      <hr />
      <div>
        <Accordion id="section-acc"  open={open} toggle={toggleAcco}>
          {playerRoles.map((r) => (
            <AccordionItem>
